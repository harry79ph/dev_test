...
const Home = () => (
  <div className={`container-sm ${style.main}`}>
    <div>
      ...
      <p>Since the start of 2022, new exoplanets discovered with the help of technology, shedding light on the distant and mysterious worlds. But what is an exoplanet?</p>
      <p>All of the planets in our solar system orbit around the Sun. Planets that orbit around other stars are called <em>exoplanets</em>. Here is a list of exoplanets discovered in 2022:</p>
    </div>
  </div>
);
